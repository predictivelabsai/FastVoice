...
# Compatibility names retained internally for upstream mergeability. FastVoice
# never supplies these values and does not expose managed-service routes.
DOGRAH_MPS_SECRET_KEY = None
MPS_API_URL = ""
DOGRAH_DEVOPS_SECRET = os.getenv("FASTVOICE_DEVOPS_SECRET") or None

"""Opt-in marker for exposing a FastAPI route through the FastVoice SDK.

The generated SDK client (`sdk/python/src/fastvoice_sdk/_generated_client.py`)
is built by walking the backend's OpenAPI
...
def sdk_expose(*, method: str, description: str = "") -> dict[str, Any]:
    ...
    `method` becomes the Python SDK method name.

"""HTTP client for the FastVoice REST API.
...
class FastVoiceClient(_GeneratedClient):
    """Sync HTTP client. Suitable for scripts, pytest, and the LLM SDK
    exec sandbox.

    Auth precedence:
        1. `api_key` kwarg
        2. `FASTVOICE_API_KEY` env var
    ...
    def __init__(
        ...
        *,
        ...
        resolved_url = base_url or os.environ.get(
            "FASTVOICE_API_URL", "http://localhost:8000"
        )
        self.base_url = resolved_url.rstrip("/")
        self.api_key = api_key or os.environ.get("FASTVOICE_API_KEY")
    ...
    def __enter__(self) -> FastVoiceClient:
        return self

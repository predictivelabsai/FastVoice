...
#   filename:  fastvoice-openapi-XXXXXX.json.PYYSL7bWmW
#   timestamp: 2026-08-11T13:20:02+00:00
...
class PresetToolParameter(BaseModel):
    """
    A parameter injected by FastVoice at runtime.
    """
...
class HttpApiConfig(BaseModel):
    ...
    """
    Parameters injected by FastVoice from fixed values or workflow context templates.
    """
...
class HttpTransferResolverConfig(BaseModel):
    ...
    """
    Optional short message played while FastVoice resolves routing.
    """
    parameters: Annotated[list[ToolParameter] | None, Field(title='Parameters')] = None
    """
